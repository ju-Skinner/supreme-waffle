...
class PdsIconContainer extends React.PureComponent<InternalProps> {
  constructor(props: InternalProps) {
    ...
    if (this.props.name) {
      console.warn(
        'In Pine React, you import icons from "@ju-skinner/ideal-octo-sniffle" and set the icon you imported to the "icon" property. Setting the "name" property has no effect.'
      );
    }
  }
